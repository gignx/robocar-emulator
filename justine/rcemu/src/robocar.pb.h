...
#ifndef PROTOBUF_robocar_2eproto__INCLUDED
#define PROTOBUF_robocar_2eproto__INCLUDED
...
const CarData_ProtoCarType CarData_ProtoCarType_ProtoCarType_MAX = CarData_ProtoCarType_CAUGHT;
...
class CarData : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_robocar_2eproto();
  friend void protobuf_AssignDesc_robocar_2eproto();
  friend void protobuf_ShutdownFile_robocar_2eproto();
...
inline void CarData::set_team(const char* value) {
  ...
  team_->assign(value);
  // @@protoc_insertion_point(field_set_char:justine.robocar.CarData.team)
}
inline void CarData::set_team(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:justine.robocar.CarData.team)
}
...
template <> struct is_proto_enum< ::justine::robocar::CarData_ProtoCarType> : ::google::protobuf::internal::true_type {};
template <>
...
#endif  // PROTOBUF_robocar_2eproto__INCLUDED
