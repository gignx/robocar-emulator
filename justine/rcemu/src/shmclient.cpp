...
void justine::sampleclient::ShmClient::foo ( void )
{
  ...
  std::cout << random_node << std::endl
            << num_edges ( random_node ) << std::endl;
}
...
void justine::sampleclient::ShmClient::car (
...
void justine::sampleclient::ShmClient::route1 ( boost::asio::ip::tcp::socket & socket, int id )
{
  ...
  size_t length = std::sprintf (
    data,
    "<route 6 %d 2969934868 651365957 320900801 1348670109 320900594 1348670117>",
    id );
...
void justine::sampleclient::ShmClient::route2 ( boost::asio::ip::tcp::socket & socket, int id )
{
  ...
  size_t length = std::sprintf (
    data,
    "<route 6 %d 1348670117 320900594 1348670109 320900801 651365957 2969934868>",
    id );
